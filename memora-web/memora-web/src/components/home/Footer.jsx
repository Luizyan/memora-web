const InstagramIcon = () => (
  <svg width={16} height={16} viewBox="0 0 24 24" fill="#fff">
    <path d="M7.75 2h8.5A5.75 5.75 0 0 1 22 7.75v8.5A5.75 5.75 0 0 1 16.25 22h-8.5A5.75 5.75 0 0 1 2 16.25v-8.5A5.75 5.75 0 0 1 7.75 2zm0-2C3.47 0 .25 3.22.25 7.75v8.5C.25 20.78 3.47 24 7.75 24h8.5c4.53 0 7.75-3.22 7.75-7.75v-8.5C24 3.22 20.78 0 16.25 0h-8.5zM12 7a5 5 0 1 0 0 10A5 5 0 0 0 12 7zm0-2a7 7 0 1 1 0 14A7 7 0 0 1 12 5zm4.5-.25a1.25 1.25 0 1 0-2.5-.001A1.25 1.25 0 0 0 16.5 4.75z"/>
  </svg>
);
      ...
      <div style={{
        ...
        <div>
          ...
          <div style={{ display: 'flex', gap: 10, marginTop: 20 }}>
            ...
            {socialIcon('#EA4335', MailIcon, 'mailto:contato@memora.com.br')}
            {socialIcon('#25D366', PhoneIcon, 'tel:6139630030')}
          </div>
        </div>
