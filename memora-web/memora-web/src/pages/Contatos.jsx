          ...
          <div>
            <div className="contatos-info-box">
              ...
              <div className="contatos-social-section">
                ...
                <div className="contatos-social-buttons">
                  ...
                  >
                      <svg fill="currentColor" viewBox="0 0 24 24">
                        <path d="M23.498 6.186a2.974 2.974 0 00-2.092-2.104C19.555 3.5 12 3.5 12 3.5s-7.555 0-9.406.582A2.974 2.974 0 00.502 6.186C0 8.05 0 12 0 12s0 3.95.502 5.814a2.974 2.974 0 002.092 2.104C4.445 20.5 12 20.5 12 20.5s7.555 0 9.406-.582a2.974 2.974 0 002.092-2.104C24 15.95 24 12 24 12s0-3.95-.502-5.814zM9.75 15.568V8.432L15.818 12 9.75 15.568z"/>
                      </svg>
                  </a>
